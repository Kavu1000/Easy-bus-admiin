            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-600">Analyze operational data and performance</p>
                    </div>
                    ...
                    <div className="flex space-x-3">
                        <select
                            ...
                            className="border-2 border-gray-400 bg-white rounded-lg px-4 py-2 text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none font-medium"
                        >
                ...
                {/* Report Type Tabs */}
                <div className="bg-white border-b border-gray-200 px-6 rounded-lg shadow-sm">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                ...
                                <div className="bg-white rounded-lg shadow-sm p-6">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-2xl font-bold text-gray-900">{todayStats.totalPassengers.toLocaleString()}</p>
                                        </div>
                                ...
                                <div className="bg-white rounded-lg shadow-sm p-6">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-2xl font-bold text-gray-900">฿{todayStats.totalRevenue.toLocaleString()}</p>
                                        </div>
                                ...
                                <div className="bg-white rounded-lg shadow-sm p-6">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <p className="text-sm font-medium text-gray-600">Buses Operating</p>
                                            <p className="text-2xl font-bold text-gray-900">{todayStats.busesOperating}</p>
                                        </div>
                                    ...
                                    <div className="mt-4">
                                        <span className="text-sm text-gray-500">Operational units</span>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-lg shadow-sm p-6">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-2xl font-bold text-gray-900">{todayStats.avgOccupancy}%</p>
                                        </div>
                            ...
                            <div className="bg-white rounded-lg shadow-sm p-6">
                                <div className="flex items-center justify-between mb-6">
                                    <h3 className="text-lg font-semibold text-gray-900">Hourly On-Time Performance</h3>
                                ...
                                <div className="h-80">
                                    ...
                                    <div className="flex items-center justify-center space-x-6 mb-4">
                                        ...
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <span className="text-sm text-gray-600">Bus Count</span>
                                        </div>
                                    </div>
                                                ...
                                                {mockHourlyPerformance.map((data, index) => {
                                                    ...
                                                    return (
                                                        <div key={data.hour} className="flex flex-col items-center relative group">
                                                            ...
                                                            <div
                                                                className="absolute w-2 h-2 bg-blue-500 rounded-full transform -translate-x-1/2 z-20"
                                                                style={{
                                                                    bottom: `${lineHeight}%`,
                                                                    left: '50%'
                                                                }}
                                                            ...
                                                            {/* Bus count bar */}
                                                            <div
                                                                className="w-4 bg-gray-300 rounded-t hover:bg-gray-400 transition-colors"
                                    ...
                                    <div className="grid grid-cols-3 gap-4 mt-6 pt-4 border-t border-gray-200">
                                        ...
                                        <div className="text-center">
                                            ...
                                            <div className="text-xs text-gray-500">Peak Buses/Hour</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="space-y-6">
                            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                                <div className="px-6 py-4 border-b border-gray-200">
                                    <h3 className="text-lg font-semibold text-gray-900">Route Report</h3>
                                </div>
                                                ...
                                                <tr key={index} className="hover:bg-gray-50">
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <div className="flex items-center">
                                                            ...
                                                            <span className="text-sm text-gray-900">{route.avgOccupancy}%</span>
                                                        </div>
                                                    </td>
                                                    <td className="px-6 py-4 whitespace-nowrap">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="bg-white rounded-lg shadow-sm p-6">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-gray-600">Buses arrived on time</p>
                                    </div>
                                </div>
                                            ...
                                            <div className="relative h-full flex items-end justify-between px-4">
                                                {mockWeeklyTrend.map((data, index) => (
                                                    <div key={data.date} className="flex flex-col items-center relative group">
                                                        {/* Tooltip */}
                                                        <div className="absolute -top-20 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs rounded px-3 py-2 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10">
                                                        ...
                                                        <div
                                                            className="absolute w-3 h-3 bg-green-500 rounded-full border-2 border-white transform -translate-x-1/2 z-20 shadow-sm"
                                                            style={{
                                                        ...
                                                        <div
                                                            className="absolute w-3 h-3 bg-blue-500 rounded-full border-2 border-white transform -translate-x-1/2 z-20 shadow-sm"
                                                            style={{
                                                        ...
                                                        <div className="text-center mt-2">
                                                            <div className="text-xs font-medium text-gray-700">{data.date}</div>
